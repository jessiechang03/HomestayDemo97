...
echo"<h2>Kemaskini Analisis Tempahan</h2>
<p>| <a href ='menuutamaadmin.php' >Menu Utama |</a>
<a href ='analisisadmin.php' >Senarai Laporan |</a></p>";
...
<form action='kemaskinianalisis.php?IDTempahan=<?PHP echo $idtempahanW; ?>' method='POST'>
...
IDTempahan='$idtempahan',IDPelanggan='$idpelanggan',IDPengurus='$idpengurus',NoBilik='$nobilik',TarikhDaftarMasuk='$tarikhdaftarmasuk',TarikhDaftarKeluar='$tarikhdaftarkeluar',JumlahHarga='$jumlahharga' where IDTempahan='$idtempahanW' "))
{
    ...
    window.location.href='analisisadmin.php';</script>";
}
else
{
    //langkah 9.2 :
