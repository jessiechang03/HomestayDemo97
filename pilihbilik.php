...
<h1>Pilih Bilik</h1>
<p>Sila Pilih Bilik Anda</p>
<p style='color:#030303'>| <a href='menuutamapelanggan.php' style='color:#009933'>Menu Utama</a> | 
 <a href='tempahbilik.php' style='color:#009933'>Kembali</a> |</p>
...
<div class="carousel" data-flickity='{ "wrapAround": true }'>
  <div class="carousel-cell">
	...
	<div class="slide-img">
	  ...
	  <div class="overlay"><a href="tempahan.php?Z=137" class="buy-btn">Tempah</a></div>
	</div>
  ...
  <div class="carousel-cell">
	...
	<div class="slide-img">
	  ...
	  <div class="overlay"><a href="tempahan.php?Z=205" class="buy-btn">Tempah</a></div>
	</div>
	<div class="detail-box">
  ...
  <div class="carousel-cell">
	...
	<div class="slide-img">
	  ...
	  <div class="overlay"><a href="tempahan.php?Z=245" class="buy-btn">Tempah</a></div>
	</div>
	<div class="detail-box">
  ...
  <div class="carousel-cell">
	...
	<div class="slide-img">
	  ...
	  <div class="overlay"><a href="tempahan.php?Z=666" class="buy-btn">Tempah</a></div>
	</div>
	<div class="detail-box">
  ...
  <div class="carousel-cell">
	...
	<div class="slide-img">
	  ...
	  <div class="overlay"><a href="tempahan.php?Z=696" class="buy-btn">Tempah</a></div>
	</div>
	<div class="detail-box">
  ...
  <div class="carousel-cell">
	...
	<div class="slide-img">
	  ...
	  <div class="overlay"><a href="tempahan.php?Z=853" class="buy-btn">Tempah</a></div>
	</div>
	<div class="detail-box">
  ...
  <div class="carousel-cell">
	...
	<div class="slide-img">
	  ...
	  <div class="overlay"><a href="tempahan.php?Z=857" class="buy-btn">Tempah</a></div>
	</div>
	<div class="detail-box">
  ...
  <div class="carousel-cell">
	...
	<div class="slide-img">
	  ...
	  <div class="overlay"><a href="tempahan.php?Z=131" class="buy-btn">Tempah</a></div>
	</div>
	<div class="detail-box">
