...
<p style='color:#030303'>| <a href='menuutamaadmin.php' style='color:#009933'>Menu Utama</a> | 
 <a href='daftarpelangganadmin.php' style='color:#009933'>Tambah Pelanggan</a> |</p>";
echo"<form action='senaraipelangganadmin.php' method='POST' target='_SELF'>
<table>
<tr>
<td>
...
while($row=mysqli_fetch_array($sqlselect)){
    ...
    <tr>
         ...
         <td><a href='kemaskinipelanggan.php?IDPelanggan=".$row['IDPelanggan']."' style='color:#0000ff'>Kemaskini</a></td>
         <td><a href='deletepelanggan.php?IDPelanggan=".$row['IDPelanggan']."'
